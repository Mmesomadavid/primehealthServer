...
export const signup = async (req, res, next) => {
  ...
  const { accountType, email, phone, username, password } = req.body;
  ...
  if (accountType === 'patient') {
    user = new Patient({accountType, username, phone, email, password: hashedPassword });
  } else if (accountType === 'doctor') {
    user = new Doctor({accountType, username, phone, email, password: hashedPassword });
  } else {
